...
def test_step_payload_applies_left_local_post_rotation_after_z_flip_only_on_left_hand():
    ...
    expected_right = _FLIP_Z_4X4 @ transform @ _FLIP_Z_4X4
    expected_left = expected_right @ _LEFT_STEP_LOCAL_POST_Z_FLIP_4X4
    ...
    np.testing.assert_allclose(left_transform[:3, 3], expected_right[:3, 3], atol=1e-6)
